          ...
          {(id: number) => {
            ...
            return (
              <box cssName="notification-popup" orientation={1} spacing={4}>
                ...
                <label cssName="notification-popup-summary" label={n.summary} halign={Gtk.Align.START} ellipsize={Pango.EllipsizeMode.END} />
                {n.body
                  ? <label cssName="notification-popup-body" label={n.body} halign={Gtk.Align.START} wrap={true} maxWidthChars={40} />
                  : <box />}
              </box>
            )
          }}
